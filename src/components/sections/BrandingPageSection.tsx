...
import { brandingPage, pricingNote } from "@/data/content";
import { AnimatedTitle } from "@/components/ui/AnimatedTitle";
import { ButtonLink } from "@/components/ui/ButtonLink";

export function BrandingPageSection() {
  return (
    <section
      data-scroll="light"
    ...
    >
      <div className="about-page-shell">
        <div className="max-w-5xl">
          <AnimatedTitle
            headline={brandingPage.headline}
            alternate={brandingPage.alternate}
          />
        </div>
      </div>
      ...
      <div className="padding-global">
        <div className="container-large">
          ...
          <div className="dev-page-stacks">
            {brandingPage.facts.flatMap((row) =>
              [
          ...
          <div className="about-page-principles">
            {brandingPage.principles.map((principle) => (
              ...
              {brandingPage.cases.map((item) => (
                <div key={item.label} className="service-page-case">
                  ...
                  {"href" in item && item.href ? (
                    <ButtonLink href={item.href}>see the case</ButtonLink>
                  ) : null}
                </div>
              ))}
            </div>
          ...
          <div className="pricing-note service-page-pricing">
            <div>
              ...
              <h3 className="heading-h5 m-0">From 50€</h3>
            </div>
