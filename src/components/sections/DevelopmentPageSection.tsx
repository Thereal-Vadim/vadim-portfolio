...
import { developmentPage, pricingNote } from "@/data/content";
...
export function DevelopmentPageSection() {
  return (
    <section
      data-scroll="light"
    ...
    >
      <div className="about-page-shell">
        <div className="w-full">
          <AnimatedTitle
            headline={developmentPage.headline}
            alternate={developmentPage.alternate}
            singleLine
          />
        </div>
      </div>
      ...
      <div className="padding-global">
        <div className="container-large">
          ...
          <div className="dev-page-stacks">
            {developmentPage.facts.flatMap((row) =>
              [
          ...
          <div className="about-page-principles">
            {developmentPage.principles.map((principle) => (
          ...
          <div className="service-page-cases">
            ...
            <div className="service-page-case-grid">
              {developmentPage.cases.map((item) => (
                <div key={item.label} className="service-page-case">
                  <p className="eyebrow mb-2">{item.kind}</p>
          ...
          <div className="pricing-note service-page-pricing">
            <div>
              ...
              <h3 className="heading-h5 m-0">From 100€</h3>
            </div>
